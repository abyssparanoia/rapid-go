...
var file_rapid_admin_api_v1_model_tenant_proto_rawDesc = []byte{
...
var (
	...
	file_rapid_admin_api_v1_model_tenant_proto_rawDescData = file_rapid_admin_api_v1_model_tenant_proto_rawDesc
)
...
func file_rapid_admin_api_v1_model_tenant_proto_rawDescGZIP() []byte {
	file_rapid_admin_api_v1_model_tenant_proto_rawDescOnce.Do(func() {
		file_rapid_admin_api_v1_model_tenant_proto_rawDescData = protoimpl.X.CompressGZIP(file_rapid_admin_api_v1_model_tenant_proto_rawDescData)
	})
...
var file_rapid_admin_api_v1_model_tenant_proto_goTypes = []interface{}{
...
func file_rapid_admin_api_v1_model_tenant_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rapid_admin_api_v1_model_tenant_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Tenant); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_rapid_admin_api_v1_model_tenant_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_rapid_admin_api_v1_model_tenant_proto_rawDesc = nil
