...
const (
	AdminV1Service_AdminCreateAssetPresignedURL_FullMethodName = "/rapid.admin_api.v1.AdminV1Service/AdminCreateAssetPresignedURL"
	AdminV1Service_AdminGetTenant_FullMethodName               = "/rapid.admin_api.v1.AdminV1Service/AdminGetTenant"
	AdminV1Service_AdminListTenants_FullMethodName             = "/rapid.admin_api.v1.AdminV1Service/AdminListTenants"
	AdminV1Service_AdminCreateTenant_FullMethodName            = "/rapid.admin_api.v1.AdminV1Service/AdminCreateTenant"
	AdminV1Service_AdminUpdateTenant_FullMethodName            = "/rapid.admin_api.v1.AdminV1Service/AdminUpdateTenant"
	AdminV1Service_AdminDeleteTenant_FullMethodName            = "/rapid.admin_api.v1.AdminV1Service/AdminDeleteTenant"
	AdminV1Service_AdminCreateStaff_FullMethodName             = "/rapid.admin_api.v1.AdminV1Service/AdminCreateStaff"
)
...
func (c *adminV1ServiceClient) AdminCreateAssetPresignedURL(ctx context.Context, in *AdminCreateAssetPresignedURLRequest, opts ...grpc.CallOption) (*AdminCreateAssetPresignedURLResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdminV1Service_AdminCreateAssetPresignedURL_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminV1ServiceClient) AdminGetTenant(ctx context.Context, in *AdminGetTenantRequest, opts ...grpc.CallOption) (*AdminGetTenantResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdminV1Service_AdminGetTenant_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminV1ServiceClient) AdminListTenants(ctx context.Context, in *AdminListTenantsRequest, opts ...grpc.CallOption) (*AdminListTenantsResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdminV1Service_AdminListTenants_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminV1ServiceClient) AdminCreateTenant(ctx context.Context, in *AdminCreateTenantRequest, opts ...grpc.CallOption) (*AdminCreateTenantResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdminV1Service_AdminCreateTenant_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminV1ServiceClient) AdminUpdateTenant(ctx context.Context, in *AdminUpdateTenantRequest, opts ...grpc.CallOption) (*AdminUpdateTenantResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdminV1Service_AdminUpdateTenant_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminV1ServiceClient) AdminDeleteTenant(ctx context.Context, in *AdminDeleteTenantRequest, opts ...grpc.CallOption) (*AdminDeleteTenantResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdminV1Service_AdminDeleteTenant_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminV1ServiceClient) AdminCreateStaff(ctx context.Context, in *AdminCreateStaffRequest, opts ...grpc.CallOption) (*AdminCreateStaffResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdminV1Service_AdminCreateStaff_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AdminV1Service_AdminCreateAssetPresignedURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminV1Service_AdminCreateAssetPresignedURL_FullMethodName,
	}
...
func _AdminV1Service_AdminGetTenant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminV1Service_AdminGetTenant_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AdminV1Service_AdminListTenants_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminV1Service_AdminListTenants_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AdminV1Service_AdminCreateTenant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminV1Service_AdminCreateTenant_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AdminV1Service_AdminUpdateTenant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminV1Service_AdminUpdateTenant_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AdminV1Service_AdminDeleteTenant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminV1Service_AdminDeleteTenant_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AdminV1Service_AdminCreateStaff_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminV1Service_AdminCreateStaff_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
