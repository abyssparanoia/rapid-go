...
var file_rapid_admin_api_v1_api_proto_rawDesc = []byte{
...
var file_rapid_admin_api_v1_api_proto_goTypes = []interface{}{
...
func file_rapid_admin_api_v1_api_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_rapid_admin_api_v1_api_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_rapid_admin_api_v1_api_proto_rawDesc = nil
