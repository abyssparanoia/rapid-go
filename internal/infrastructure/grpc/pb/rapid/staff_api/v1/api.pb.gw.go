...
/*
Package staff_apiv1 is a reverse proxy.
...
func request_StaffV1Service_CreateAssetPresignedURL_0(ctx context.Context, marshaler runtime.Marshaler, client StaffV1ServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
...
func local_request_StaffV1Service_CreateAssetPresignedURL_0(ctx context.Context, marshaler runtime.Marshaler, server StaffV1ServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq CreateAssetPresignedURLRequest
		metadata runtime.ServerMetadata
	)
...
func request_StaffV1Service_GetStaff_0(ctx context.Context, marshaler runtime.Marshaler, client StaffV1ServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
...
func local_request_StaffV1Service_GetStaff_0(ctx context.Context, marshaler runtime.Marshaler, server StaffV1ServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq GetStaffRequest
		metadata runtime.ServerMetadata
		err      error
...
var filter_StaffV1Service_ListStaffs_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}

func request_StaffV1Service_ListStaffs_0(ctx context.Context, marshaler runtime.Marshaler, client StaffV1ServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq ListStaffsRequest
		metadata runtime.ServerMetadata
	)
	if req.Body != nil {
		_, _ = io.Copy(io.Discard, req.Body)
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_StaffV1Service_ListStaffs_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_StaffV1Service_ListStaffs_0(ctx context.Context, marshaler runtime.Marshaler, server StaffV1ServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq ListStaffsRequest
		metadata runtime.ServerMetadata
	)
...
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterStaffV1ServiceHandlerFromEndpoint instead.
// GRPC interceptors will not work for this type of registration. To use interceptors, you must use the "runtime.WithMiddlewares" option in the "runtime.NewServeMux" call.
func RegisterStaffV1ServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server StaffV1ServiceServer) error {
	mux.Handle(http.MethodPost, pattern_StaffV1Service_CreateAssetPresignedURL_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/rapid.staff_api.v1.StaffV1Service/CreateAssetPresignedURL", runtime.WithHTTPPathPattern("/staff/v1/assets/-/presigned_url"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_StaffV1Service_CreateAssetPresignedURL_0(annotatedContext, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle(http.MethodGet, pattern_StaffV1Service_GetStaff_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/rapid.staff_api.v1.StaffV1Service/GetStaff", runtime.WithHTTPPathPattern("/staff/v1/staffs/{staff_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_StaffV1Service_GetStaff_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_StaffV1Service_GetStaff_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
	mux.Handle(http.MethodGet, pattern_StaffV1Service_ListStaffs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/rapid.staff_api.v1.StaffV1Service/ListStaffs", runtime.WithHTTPPathPattern("/staff/v1/staffs"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_StaffV1Service_ListStaffs_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
...
// RegisterStaffV1ServiceHandlerFromEndpoint is same as RegisterStaffV1ServiceHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterStaffV1ServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterStaffV1ServiceHandler(ctx, mux, conn)
}

// RegisterStaffV1ServiceHandler registers the http handlers for service StaffV1Service to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterStaffV1ServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterStaffV1ServiceHandlerClient(ctx, mux, NewStaffV1ServiceClient(conn))
}

// RegisterStaffV1ServiceHandlerClient registers the http handlers for service StaffV1Service
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "StaffV1ServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "StaffV1ServiceClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "StaffV1ServiceClient" to call the correct interceptors. This client ignores the HTTP middlewares.
func RegisterStaffV1ServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client StaffV1ServiceClient) error {
	mux.Handle(http.MethodPost, pattern_StaffV1Service_CreateAssetPresignedURL_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/rapid.staff_api.v1.StaffV1Service/CreateAssetPresignedURL", runtime.WithHTTPPathPattern("/staff/v1/assets/-/presigned_url"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_StaffV1Service_CreateAssetPresignedURL_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle(http.MethodGet, pattern_StaffV1Service_GetStaff_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/rapid.staff_api.v1.StaffV1Service/GetStaff", runtime.WithHTTPPathPattern("/staff/v1/staffs/{staff_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_StaffV1Service_GetStaff_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle(http.MethodGet, pattern_StaffV1Service_ListStaffs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/rapid.staff_api.v1.StaffV1Service/ListStaffs", runtime.WithHTTPPathPattern("/staff/v1/staffs"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_StaffV1Service_ListStaffs_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
