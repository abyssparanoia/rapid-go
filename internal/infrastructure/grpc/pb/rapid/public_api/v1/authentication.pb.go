...
type PublicSignInRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *PublicSignInRequest) Reset() {
	*x = PublicSignInRequest{}
...
func (x *PublicSignInRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PublicSignInRequest) ProtoMessage() {}

func (x *PublicSignInRequest) ProtoReflect() protoreflect.Message {
	mi := &file_rapid_public_api_v1_authentication_proto_msgTypes[0]
...
// Deprecated: Use PublicSignInRequest.ProtoReflect.Descriptor instead.
func (*PublicSignInRequest) Descriptor() ([]byte, []int) {
	return file_rapid_public_api_v1_authentication_proto_rawDescGZIP(), []int{0}
}

type PublicSignInResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PublicSignInResponse) Reset() {
	*x = PublicSignInResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *PublicSignInResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PublicSignInResponse) ProtoMessage() {}

func (x *PublicSignInResponse) ProtoReflect() protoreflect.Message {
	mi := &file_rapid_public_api_v1_authentication_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PublicSignInResponse.ProtoReflect.Descriptor instead.
func (*PublicSignInResponse) Descriptor() ([]byte, []int) {
	return file_rapid_public_api_v1_authentication_proto_rawDescGZIP(), []int{1}
}

func (x *PublicSignInResponse) GetUser() *v1.User {
	if x != nil {
		return x.User
	}
	return nil
...
var file_rapid_public_api_v1_authentication_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x15, 0x0a, 0x13, 0x50, 0x75,
	0x62, 0x6c, 0x69, 0x63, 0x53, 0x69, 0x67, 0x6e, 0x49, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x22, 0x4e, 0x0a, 0x14, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x53, 0x69, 0x67, 0x6e, 0x49,
	...
	0x72, 0x42, 0xec, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x72, 0x61, 0x70, 0x69, 0x64, 0x2e,
	0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x5f, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x42, 0x13, 0x41,
	...
	0x61, 0x70, 0x69, 0x64, 0x2d, 0x67, 0x6f, 0x2f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2f, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x62, 0x2f, 0x72, 0x61, 0x70, 0x69, 0x64, 0x2f, 0x70, 0x75,
...
var file_rapid_public_api_v1_authentication_proto_goTypes = []interface{}{
	...
	(*PublicSignInResponse)(nil), // 1: rapid.public_api.v1.PublicSignInResponse
	(*v1.User)(nil),              // 2: rapid.model.v1.User
}
var file_rapid_public_api_v1_authentication_proto_depIdxs = []int32{
	2, // 0: rapid.public_api.v1.PublicSignInResponse.user:type_name -> rapid.model.v1.User
...
func file_rapid_public_api_v1_authentication_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rapid_public_api_v1_authentication_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PublicSignInRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rapid_public_api_v1_authentication_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PublicSignInResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
