...
func file_rapid_public_api_v1_api_health_check_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rapid_public_api_v1_api_health_check_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_rapid_public_api_v1_api_health_check_proto_msgTypes[1].Exporter = func(v any, i int) any {
