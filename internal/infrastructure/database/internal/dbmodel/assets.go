...
var AssetRels = struct {
	...
	TypeAssetType    string
}{
	AssetContentType: "AssetContentType",
	TypeAssetType:    "TypeAssetType",
}

// assetR is where relationships are stored.
type assetR struct {
	AssetContentType *ContentType `boil:"AssetContentType" json:"AssetContentType" toml:"AssetContentType" yaml:"AssetContentType"`
	TypeAssetType    *AssetType   `boil:"TypeAssetType" json:"TypeAssetType" toml:"TypeAssetType" yaml:"TypeAssetType"`
}
...
func (o *Asset) GetAssetContentType() *ContentType {
	if o == nil {
		return nil
	}

	return o.R.GetAssetContentType()
}

func (r *assetR) GetAssetContentType() *ContentType {
	if r == nil {
		return nil
	}

	return r.AssetContentType
}

func (o *Asset) GetTypeAssetType() *AssetType {
	if o == nil {
		return nil
	}

	return o.R.GetTypeAssetType()
}

func (r *assetR) GetTypeAssetType() *AssetType {
	if r == nil {
		return nil
	}

	return r.TypeAssetType
}
...
// AssetContentType pointed to by the foreign key.
func (o *Asset) AssetContentType(mods ...qm.QueryMod) contentTypeQuery {
	queryMods := []qm.QueryMod{
		qm.Where("`id` = ?", o.ContentType),
	}

	queryMods = append(queryMods, mods...)

	return ContentTypes(queryMods...)
}

// TypeAssetType pointed to by the foreign key.
func (o *Asset) TypeAssetType(mods ...qm.QueryMod) assetTypeQuery {
	queryMods := []qm.QueryMod{
		qm.Where("`id` = ?", o.Type),
	}
...
// LoadAssetContentType allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (assetL) LoadAssetContentType(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAsset interface{}, mods queries.Applicator) error {
	var slice []*Asset
	var object *Asset
	...
	if singular {
		...
		args[object.ContentType] = struct{}{}
	...
	query := NewQuery(
		...
		qm.WhereIn(`content_types.id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		...
		object.R.AssetContentType = foreign
		if foreign.R == nil {
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.ContentType == foreign.ID {
				local.R.AssetContentType = foreign
				if foreign.R == nil {
					foreign.R = &contentTypeR{}
				}
...
// LoadTypeAssetType allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (assetL) LoadTypeAssetType(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAsset interface{}, mods queries.Applicator) error {
	var slice []*Asset
	var object *Asset
	...
	query := NewQuery(
		qm.From(`asset_types`),
		qm.WhereIn(`asset_types.id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results of eager load for asset_types")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for asset_types")
	}
	...
	if singular {
		foreign := resultSlice[0]
		object.R.TypeAssetType = foreign
		if foreign.R == nil {
			foreign.R = &assetTypeR{}
		}
		foreign.R.TypeAssets = append(foreign.R.TypeAssets, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.Type == foreign.ID {
				local.R.TypeAssetType = foreign
				if foreign.R == nil {
					foreign.R = &assetTypeR{}
				}
				foreign.R.TypeAssets = append(foreign.R.TypeAssets, local)
				break
			}
		}
	}
...
// SetAssetContentTypeG of the asset to the related item.
// Sets o.R.AssetContentType to related.
// Adds o to related.R.Assets.
// Uses the global database handle.
func (o *Asset) SetAssetContentTypeG(ctx context.Context, insert bool, related *ContentType) error {
	return o.SetAssetContentType(ctx, boil.GetContextDB(), insert, related)
}

// SetAssetContentTypeP of the asset to the related item.
// Sets o.R.AssetContentType to related.
// Adds o to related.R.Assets.
// Panics on error.
func (o *Asset) SetAssetContentTypeP(ctx context.Context, exec boil.ContextExecutor, insert bool, related *ContentType) {
	if err := o.SetAssetContentType(ctx, exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetAssetContentTypeGP of the asset to the related item.
// Sets o.R.AssetContentType to related.
// Adds o to related.R.Assets.
// Uses the global database handle and panics on error.
func (o *Asset) SetAssetContentTypeGP(ctx context.Context, insert bool, related *ContentType) {
	if err := o.SetAssetContentType(ctx, boil.GetContextDB(), insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetAssetContentType of the asset to the related item.
// Sets o.R.AssetContentType to related.
// Adds o to related.R.Assets.
func (o *Asset) SetAssetContentType(ctx context.Context, exec boil.ContextExecutor, insert bool, related *ContentType) error {
	var err error
	if insert {
	...
	o.ContentType = related.ID
	if o.R == nil {
		o.R = &assetR{
			AssetContentType: related,
		}
	} else {
		o.R.AssetContentType = related
	}
...
// SetTypeAssetTypeG of the asset to the related item.
// Sets o.R.TypeAssetType to related.
// Adds o to related.R.TypeAssets.
// Uses the global database handle.
func (o *Asset) SetTypeAssetTypeG(ctx context.Context, insert bool, related *AssetType) error {
	return o.SetTypeAssetType(ctx, boil.GetContextDB(), insert, related)
}

// SetTypeAssetTypeP of the asset to the related item.
// Sets o.R.TypeAssetType to related.
// Adds o to related.R.TypeAssets.
// Panics on error.
func (o *Asset) SetTypeAssetTypeP(ctx context.Context, exec boil.ContextExecutor, insert bool, related *AssetType) {
	if err := o.SetTypeAssetType(ctx, exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetTypeAssetTypeGP of the asset to the related item.
// Sets o.R.TypeAssetType to related.
// Adds o to related.R.TypeAssets.
// Uses the global database handle and panics on error.
func (o *Asset) SetTypeAssetTypeGP(ctx context.Context, insert bool, related *AssetType) {
	if err := o.SetTypeAssetType(ctx, boil.GetContextDB(), insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetTypeAssetType of the asset to the related item.
// Sets o.R.TypeAssetType to related.
// Adds o to related.R.TypeAssets.
func (o *Asset) SetTypeAssetType(ctx context.Context, exec boil.ContextExecutor, insert bool, related *AssetType) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	if o.R == nil {
		o.R = &assetR{
			TypeAssetType: related,
		}
	} else {
		o.R.TypeAssetType = related
	}

	if related.R == nil {
		related.R = &assetTypeR{
			TypeAssets: AssetSlice{o},
		}
	} else {
		related.R.TypeAssets = append(related.R.TypeAssets, o)
	}
