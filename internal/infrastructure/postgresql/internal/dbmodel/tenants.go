...
func (o *Tenant) UpsertGP(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) {
...
func (o *Tenant) UpsertP(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) {
...
func (o *Tenant) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	...
	if !cached {
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(tenantPrimaryKeyColumns) == 0 {
				return errors.New("dbmodel: unable to upsert tenants, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "dbmodel: unable to upsert tenants")
	}
...
func (o TenantSlice) upsertAllOnConflictColumns(ctx context.Context, exec boil.ContextExecutor, conflictColumns []string, updateColumns, insertColumns boil.Columns) (int64, error) {
	...
	if len(insert) == 0 {
		return 0, errors.New("dbmodel: unable to upsert tenants, could not build insert column list")
	}
	...
	if updateRequired && len(conflict) == 0 {
		return 0, errors.New("dbmodel: unable to upsert tenants, could not build conflict column list")
	}
