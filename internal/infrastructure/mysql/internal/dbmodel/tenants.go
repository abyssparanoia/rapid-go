...
func (tenantL) LoadStaffs(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTenant any, mods queries.Applicator) error {
	var slice []*Tenant
	var object *Tenant
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (tenantL) LoadTenantTags(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTenant any, mods queries.Applicator) error {
	var slice []*Tenant
	var object *Tenant
