...
func (mr *MockAssetMockRecorder) GenerateReadPresignedURL(ctx, path, expires interface{}) *gomock.Call {
...
func (mr *MockAssetMockRecorder) GenerateWritePresignedURL(ctx, contentType, path, expires interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
