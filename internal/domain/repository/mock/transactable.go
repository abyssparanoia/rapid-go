...
//
//	mockgen -source=transactable.go -destination=mock/transactable.go -package=mock_repository
//
...
func (mr *MockTransactableMockRecorder) ROTx(ctx, fn any) *gomock.Call {
...
func (mr *MockTransactableMockRecorder) RWTx(ctx, fn any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
