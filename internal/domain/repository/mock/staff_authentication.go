...
func (m *MockStaffAuthentication) CreateIDToken(ctx context.Context, email, password string) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStaffAuthenticationMockRecorder) CreateIDToken(ctx, email, password any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateIDToken", reflect.TypeOf((*MockStaffAuthentication)(nil).CreateIDToken), ctx, email, password)
}
