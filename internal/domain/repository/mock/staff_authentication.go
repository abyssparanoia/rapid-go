...
func (mr *MockStaffAuthenticationMockRecorder) CreateCustomToken(ctx, authUID interface{}) *gomock.Call {
...
func (mr *MockStaffAuthenticationMockRecorder) CreateIDToken(ctx, authUID, password interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStaffAuthenticationMockRecorder) CreateUser(ctx, param interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStaffAuthenticationMockRecorder) GetUserByEmail(ctx, email interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStaffAuthenticationMockRecorder) StoreClaims(ctx, authUID, staffClaims interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStaffAuthenticationMockRecorder) VerifyIDToken(ctx, idToken interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
