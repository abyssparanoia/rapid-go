...
func (m *MockStaff) Create(ctx context.Context, staff *model.Staff) (*model.Staff, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStaffMockRecorder) Create(ctx, staff interface{}) *gomock.Call {
...
func (mr *MockStaffMockRecorder) Get(ctx, query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
